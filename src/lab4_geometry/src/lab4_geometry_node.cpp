// вывод цилиндрического облака точек с использованием pointcloud 2
//frame: cloud_1
//topic: point_cloud
...
{
    ros::init(argc, argv, "lab4_geometry_node");
    ros::NodeHandle nh;
...
//// вывод цилиндрического облака точек с использованием pointcloud 1
...
//    ros::init(argc, argv, "lab4_geometry_node");
//    ros::NodeHandle nh;
//    ros::Publisher pub_pc_1 = nh.advertise<sensor_msgs::PointCloud>("point_cloud", 10);
...
//void point_cloud1(){
//    pc_1.header.frame_id = "cloud"

//            for (double k = 0; k < height; k = k +1/scalling) {
//        for (double i = 0; i < 2*M_PI; i = i + 0.01) {
